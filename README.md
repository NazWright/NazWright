...
### 🧠 About Me  
Born in Norfolk, raised in Durham, based between Delaware & Philly — I build systems where **myth meets machine.**  

I’m an AWS-certified **Cloud Developer & Practitioner** crafting intelligent systems that live at the intersection of **AI, crypto, and design**.  
Right now, I’m building **DARIA** — the *Detection And Risk-Intelligence Agent* — a real-time fraud detection architecture that blends **AWS machine learning**, **Kinesis Data Streams**, and **Web3 transparency**.

I code like I live — with precision, movement, and expression.

> “I build apps on the cloud and stack sats on the side.” ☁️ ₿
